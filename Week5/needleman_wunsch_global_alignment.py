"""
Find an optimal global alignment
of two sequences, given a scoring scheme

1. Build table of possible alignments
2. Decide on scoring scheme
3. Fill in the table with scores
4. Trace back through the table to find optimal alignments
